...
from pygen_src.llm_patterns.riscv_llm_alu_raw_stream import riscv_llm_alu_raw_stream

from pygen_src.llm_patterns.riscv_llm_bpu_capacity_pressure_stream import riscv_llm_bpu_capacity_pressure_stream
...
def factory(obj_of):
    objs = {
        ...
        "riscv_llm_alu_raw_stream": riscv_llm_alu_raw_stream,
        "riscv_llm_bpu_capacity_pressure_stream": riscv_llm_bpu_capacity_pressure_stream,
    }
