...
//P-extension instruction
`define DEFINE_P_INSTR(instr_n, instr_format, instr_category, instr_group, imm_tp = IMM) \
  class riscv_``instr_n``_instr extends riscv_p_instr; \
    `INSTR_BODY(instr_n, instr_format, instr_category, instr_group, imm_tp)
