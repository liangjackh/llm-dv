...
class riscv_instr_gen_config extends uvm_object;
  ...
  // Packed-SIMD (P) extension support
  bit                    enable_p_extension;
  ...
  `uvm_object_utils_begin(riscv_instr_gen_config)
    ...
    `uvm_field_int(enable_p_extension, UVM_DEFAULT)
  ...
  function new (string name = "");
    ...
    get_bool_arg_value("+enable_p_extension=", enable_p_extension);
